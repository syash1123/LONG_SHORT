    ...
    try:
        if transaction_type == kite.TRANSACTION_TYPE_BUY:
            ...
            if 'last_price' in ltp_data_fut and ltp_data_fut['last_price'] is not None:
                ...
                call_send_message2(f"Successfully placed buy order for {fut_trading_symbol} at market price: {market_price_fut}")
                ...
                call_send_message2("Error: 'last_price' not found in market data for FUTURE option")
            ...
            if 'last_price' in ltp_data_fut and ltp_data_fut['last_price'] is not None:
                ...
                call_send_message2(f"Successfully placed sell order for {fut_trading_symbol} at market price: {market_price_fut}")
                # Save the order details
                order_details = {
                    'timestamp': str(datetime.now()),
                    'instrument_token': instrument_token,
                ...
                call_send_message2("Error: 'last_price' not found in market data for FUTURE ")
    ...
    try:
        if transaction_type == kite.TRANSACTION_TYPE_BUY:
            ...
            if 'last_price' in ltp_data_otm_put and ltp_data_otm_put['last_price'] is not None:
                ...
                call_send_message2(f"Successfully placed buy order for {otm_put_trading_symbol} at market price: {market_price_otm_put}")
                ...
                call_send_message2("Error: 'last_price' not found in market data for OTM put option")
            ...
            if 'last_price' in ltp_data_atm_put and ltp_data_atm_put['last_price'] is not None:
                ...
                call_send_message2(f"Successfully placed sell order for {atm_put_trading_symbol} at market price: {market_price_atm_put}")
                ...
                call_send_message2("Error: 'last_price' not found in market data for ATM put option")
    ...
    try:
        if transaction_type == kite.TRANSACTION_TYPE_BUY:
            ...
            if 'last_price' in ltp_data_itm_call and ltp_data_itm_call['last_price'] is not None:
                ...
                call_send_message2(f"Successfully placed buy order for {itm_call_trading_symbol} at market price: {market_price_itm_call}")
                ...
                call_send_message2("Error: 'last_price' not found in market data for OTM call option")
            ...
            if 'last_price' in ltp_data_atm_call and ltp_data_atm_call['last_price'] is not None:
                ...
                call_send_message2(f"Successfully placed sell order for {atm_call_trading_symbol} at market price: {market_price_atm_call}")
                ...
                call_send_message2("Error: 'last_price' not found in market data for ATM call option")
...
def square_off_order(order_details):
    ...
    try:
        ...
        if 'last_price' in ltp_data and ltp_data['last_price'] is not None:
            ...
            call_send_message2(f"Successfully placed square off order for {symbol} at limit price: {market_price}")
            ...
            call_send_message2(f"Error: 'last_price' not found in market data for {symbol}")
    except Exception as e:
        print(f"Error placing square off order for {symbol}: {e}")
        call_send_message(f"Error placing square off order for {symbol}: {e}")
        call_send_message2(f"Error placing square off order for {symbol}: {e}")
...
kws = KiteTicker("5gio34lqmlmn83a5", "sjMcPbysnWOBiOqnCkfjQyOki9dqKHCp")
